...
function CookedCourseCardComponent({ course, onSelect }) {
    ...
    return (
        <motion.div
            ...
            className="flex-shrink-0 w-[300px] h-[420px] snap-start"
        >
            <Card
            ...
            >
                <img
                    ...
                    className="w-full h-full object-cover absolute inset-0 transition-transform duration-500 ease-in-out group-hover:scale-110"
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                    ...
                    <p className="text-sm text-slate-300 mb-4">{course.channel}</p>
